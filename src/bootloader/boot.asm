...
main: 
    ...
    cli                 ; disable interrupts, this way cpu can't get out of halt 
    hlt
...
msg_read_failed:      db 'Read from disk failed!', ENDL, 0    ; message to print in case of disk read failure
